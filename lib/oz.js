 ...
 * @return {Array}     Array of DOM nodes corresponding to the newly created template
 */
Oz.prototype.render = function (ctx) {
  ...
  if(isFragment(template)) {
    this.rendered = children(template);
  } else {
 ...
 * Update template
 * @param  {Object} ctx Context in which to render the template
 * @return {Array}     Array of DOM nodes corresponding to the updated (in-place) template
 */
